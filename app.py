    ...
    {marker_display_html}
        ...
        if st.session_state.chart_data:
            ...
            with st.container():
                ...
                # V42.9.40: TOGGLE GIEO QUẺ NGẪU NHIÊN — mỗi lần hỏi = quẻ mới
                ...
                if unified_clicked:
                    try:
                        ...
                        with st.spinner("⚙️ Bước 1/2: AI Offline đang phân tích quẻ..."):
                            ...
                            # V42.9.40: Chế độ Gieo Ngẫu Nhiên
...
{res_lien_mach}
            ...
            # V42.9.40: Hiển thị trạng thái Gieo Ngẫu Nhiên cho nút Q&A
                ...
                if user_question:
                    try:
                        ...
                        with st.spinner("⚙️ Bước 1/2: AI Offline đang phân tích quẻ từ câu hỏi của bạn..."):
                            ...
                            # Auto-compute Mai Hoa & Lục Hào
                            # V42.9.40: Chế độ Gieo Ngẫu Nhiên (Q&A box)
    ...
    # V42.9.40: Nếu chế độ ngẫu nhiên BẬT và đã có quẻ ngẫu nhiên → hiển thị quẻ đó
    ...
    if 'luc_hao_result' in st.session_state:
        ...
        # V42.9.40 Fix: Read actual can/chi from the result (vital for random cast)
