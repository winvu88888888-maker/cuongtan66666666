...
class FreeAIHelper:
    ...
    def _try_online_ai(self, question, chart_data=None, mai_hoa_data=None, luc_hao_data=None, topic=None,
        ...
        try:
            ...
            deep_prompt = (
                f"<system_role>\n"
                f"BẠN LÀ THIÊN CƠ ĐẠI SƯ V42.9.29 — CHUYÊN GIA DIỄN GIẢI KẾT QUẢ HUYỀN HỌC.\n"
                ...
                f"⑦ LOGIC SUY LUẬN SIÊU VIỆT & TÌM KIẾM ĐẠI SƯ: Lấy Phán Quyết làm gốc. Bạn BẮT BUỘC phải tuân thủ quy trình logic sau:\n"
                ...
                f"⑧ TRÍ TUỆ SUY LUẬN ĐỘC LẬP & TỐI ĐA HOÁ ĐỘ SÂU: Không bị giới hạn bởi khuôn mẫu cứng nhắc, BẠN HÃY PHÁT HUY TỐI ĐA KHẢ NĂNG SUY LUẬN SIÊU VIỆT CỦA MÌNH! Khi đối mặt với mọi câu hỏi (Ai/Cái gì/Nghề gì/Ở đâu/Có vấn đề gì...), BẠN KHÔNG sao chép một cách máy móc từ Chủ đề có sẵn. Thay vào đó, hãy tự do khai thác triệt để Ngũ Hành, Bát Quái, trạng thái Vượng/Suy, 12 Trường Sinh và các sao tác động lên Dụng Thần để HỘI TỤ ra MỘT KẾT LUẬN DUY NHẤT và CHI TIẾT NHẤT. Sự xuất sắc của bạn nằm ở việc TÌM RA ĐÚNG CHÂN TƯỚNG (Ví dụ: Chốt đúng 1 nghề nghiệp cụ thể nhất, hoặc chỉ đúng 1 sự vật cụ thể nhất), thay vì liệt kê an toàn nhưng chung chung.\n"
                f"⑨ ĐIỀU TRA CHI TIẾT HIỆN TRƯỜNG (DEEP FORENSIC): Hãy hoạt động như một thám tử tài ba! Dựa MỌI LUẬN ĐIỂM vào bằng chứng thực tế từ quẻ. Nếu quẻ báo có sự cố/vấn đề/tin vui, hãy tự do vẽ ra bức tranh toàn cảnh SÂU SẮC VÀ CỤ THỂ NHẤT: Vấn đề chính xác là gì? Cái gì/Ai đang tác động? Sự việc đang diễn biến ra sao? (VD: Đừng chỉ nói 'trong nhà có vấn đề', hãy phân tích bằng chứng để nói rõ 'do Huyền Vũ Thủy động tại cung Càn, khả năng cao là đường ống nước ngầm góc Tây Bắc đang bị vỡ rỉ'). Sự sắc bén của bạn đến từ việc ghép nối logic các bằng chứng, không phải bịa đặt!\n\n"
    ...
    def answer_question(self, question, chart_data=None, topic=None, selected_subject=None, mai_hoa_data=None, luc_hao_data=None, **kwargs):
        ...
        if online_result:
            ...
            final_parts.append(
                ...
                f'<div style="font-size:1.2em;font-weight:700;color:#fde68a;margin-bottom:10px;">🌐 KẾT LUẬN AI ONLINE (Gemini V42.9.29)</div>'
            ...
            if len(_off_answer_list) > 1:
                ...
                final_parts.append(
                    ...
                    f'<div style="font-size:1.2em;font-weight:700;color:#6ee7b7;margin-bottom:10px;">🖥️ KẾT LUẬN AI OFFLINE — THIÊN CƠ ĐẠI SƯ V42.9.29</div>'
                ...
                # ═══ V42.9.29: TRẢ LỜI TRỰC TIẾP CÂU HỎI ═══
                ...
                # ═══ V42.9.29: Build chi tiết luận giải ═══
                _reason_parts = []
