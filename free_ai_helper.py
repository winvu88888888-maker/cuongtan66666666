    ...
    def _try_online_ai(self, question, chart_data=None, mai_hoa_data=None, luc_hao_data=None, topic=None,
        ...
        try:
            ...
            deep_prompt = (
                ...
                f"3. PHẢI đọc <dung_than_analysis> — đây là phân tích Dụng Thần ĐẦY ĐỦ nhất. BẠN PHẢI TRÍCH DẪN TỪNG DÒNG KHI VIẾT.\n"
                f"4. Luận giải BẮT BUỘC phải DIỄN GIẢI CHI TIẾT TỪNG yếu tố: DT Vượng/Suy + Nguyên Thần + Kỵ Thần + Cừu Thần + Phi/Phục Thần + Nguyệt Lệnh + Nhật Thần + Tuần Không + Nguyệt Phá + Hào Biến (Hóa Tuyệt/Mộ/Tử/Phá/Vượng).\n"
                f"5. MỖI nhận định → PHẢI kèm [NGUỒN: phương pháp + data cụ thể]. VD: [Nguồn: LH Hào 3, Mão(Mộc), Vượng]\n"
                ...
                f"8. PHẢI viết theo <output_format> — đúng thứ tự, đúng nội dung.\n"
                f"9. DIỄN GIẢI YẾU TỐ = Giải thích TẠI SAO yếu tố đó thuận/bất lợi cho người hỏi. KHÔNG chỉ liệt kê data.\n"
                f"10. Phải ĐẾM: bao nhiêu yếu tố THUẬN LỢI (✅) vs bao nhiêu yếu tố BẤT LỢI (❌) → dẫn đến verdict.\n"
                f"</system_role>\n\n"
                ...
                f"<output_format>\n"
                f"BẠN PHẢI viết ĐÚNG format sau. KHÔNG bỏ sót mục nào. KHÔNG thay đổi thứ tự:\n\n"
                f"## 🏆 KẾT LUẬN: [COPY từ verdict_lock — ĐÚNG verdict đã tính]\n"
                f"[1-3 câu trả lời TRỰC TIẾP cho câu hỏi \"{question}\"]\n"
                f"[DẪN CHỨNG: trích dẫn 2-3 yếu tố quan trọng nhất từ data]\n\n"
                f"---\n\n"
