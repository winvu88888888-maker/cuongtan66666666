    ...
    def _try_online_ai(self, question, chart_data=None, mai_hoa_data=None, luc_hao_data=None, topic=None,
        ...
        try:
            ...
            deep_prompt = (
                ...
                f"⑦ NĂNG LỰC ĐA VŨ TRỤ: Trả lời MỌI LĨNH VỰC (Crypto, Cổ phiếu, Thể thao, Bóng đá, Chính trị, Khoa học, Tâm linh, v.v.). Hãy linh hoạt dùng Ngũ Hành và Tượng Quẻ để luận giải các khái niệm hiện đại một cách sắc bén nhất mà không được từ chối.\n\n"
