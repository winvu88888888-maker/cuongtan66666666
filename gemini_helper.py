"""
Enhanced Gemini Helper - THIÊN CƠ ĐẠI SƯ (V42.9.38 - Cross-Reference + Unleashed Intelligence + Deep Forensic)
...
class GeminiQMDGHelper:
    ...
    def __init__(self, api_key_input):
        ...
        self.version = "V42.9.38-GenAI-SDK"
            ...
            for current_api_key in self.api_keys:
                ...
                try:
                    ...
                    gen_config = genai_types.GenerateContentConfig(
                        ...
                        # Removed forced google_search to prevent Grounding from breaking formatting/persona
                    )
