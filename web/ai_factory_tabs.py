...
def render_mining_summary_on_dashboard(key_suffix=""):
    ...
    with col_status1:
        if is_recently_active:
            st.markdown("""
            <div style='padding: 15px; border-radius: 10px; background: #ffffff; text-align: center; border: 4px solid #4ade80;'>
                <h3 style='color: #000000; margin: 0;'>🟢 50 AI AGENTS</h3>
                <p style='color: #000000; margin: 5px 0 0 0; font-size: 14px; font-weight: bold;'>ĐANG KHAI THÁC</p>
                <small style='color: #64748b; opacity: 0.8;'>Lần cuối: """ + str(int(time_diff_minutes)) + """p trước</small>
            </div>
            """, unsafe_allow_html=True)
        else:
            st.markdown("""
            <div style='padding: 15px; border-radius: 10px; background: #ffffff; text-align: center; border: 4px solid #f87171;'>
                <h3 style='color: #000000; margin: 0;'>🔴 50 AI AGENTS</h3>
                <p style='color: #000000; margin: 5px 0 0 0; font-size: 14px; font-weight: bold;'>ĐANG DỪNG</p>
            </div>
            """, unsafe_allow_html=True)
    ...
    with col_status2:
        ...
        if cleanup_active and is_recently_active:
            st.markdown("""
            <div style='padding: 15px; border-radius: 10px; background: #ffffff; text-align: center; border: 4px solid #38bdf8;'>
                <h3 style='color: #000000; margin: 0;'>🔵 AI DỌN DẸP</h3>
                <p style='color: #000000; margin: 5px 0 0 0; font-size: 14px; font-weight: bold;'>ĐANG TỐI ƯU</p>
            </div>
            """, unsafe_allow_html=True)
        else:
            st.markdown("""
            <div style='padding: 15px; border-radius: 10px; background: #ffffff; text-align: center; border: 4px solid #9ca3af;'>
                <h3 style='color: #000000; margin: 0;'>⚪ AI DỌN DẸP</h3>
                <p style='color: #000000; margin: 5px 0 0 0; font-size: 14px; font-weight: bold;'>CHỜ CHU KỲ</p>
            </div>
            """, unsafe_allow_html=True)
    ...
    with col_status3:
        ...
        if github_actions_active:
            st.markdown("""
            <div style='padding: 15px; border-radius: 10px; background: #ffffff; text-align: center; border: 4px solid #4ade80;'>
                <h3 style='color: #000000; margin: 0;'>🟢 24/7 ACTIVE</h3>
                <p style='color: #000000; margin: 5px 0 0 0; font-size: 14px; font-weight: bold;'>MỖI 30 PHÚT</p>
            </div>
            """, unsafe_allow_html=True)
        else:
            st.markdown("""
            <div style='padding: 15px; border-radius: 10px; background: #ffffff; text-align: center; border: 4px solid #f87171;'>
                <h3 style='color: #000000; margin: 0;'>🔴 24/7 OFF</h3>
                <p style='color: #000000; margin: 5px 0 0 0; font-size: 14px; font-weight: bold;'>ĐÃ TẮT</p>
            </div>
            """, unsafe_allow_html=True)
